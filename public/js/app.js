...
var fetchApiData = function () {
    for (var counter = 0; counter < pokémons; counter++) {
        getPokémon(counter);
    }
};
var getPokémon = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var apiData, pokémon, pokémonType, transformedPokemon;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                pokémon = _a.sent();
                pokémonType = pokémon.types.map(function (element) { return element.type.name; }).join(", ");
                transformedPokemon = {
                    id: pokémon.id,
                    name: pokémon.name,
